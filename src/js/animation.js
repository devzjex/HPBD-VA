...
const frames = document.querySelectorAll(".frame"),
  ...
  gallery = document.querySelector(".photo-gallery"); // bộ ảnh Polaroid ở màn cuối
...
export const animate = function () {
  CTAtext.innerHTML = "Bấm vào bóng đèn nhé.";
  ...
  button.addEventListener("click", function () {
    if (button.classList.contains("switch")) {
      ...
      light.play();
      transition(darkroom);
      CTAtext.innerHTML = "Bấm vào cánh cửa";
      setTimeout(function () {
      ...
      door.play();
      transition(hallway);
      CTAtext.innerHTML = "Bấm vào món quà";
      setTimeout(function () {
